                  ...
                  <div class="card shadow mb-4">
                    ...
                    ?>
                      ...
                      <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-secondary">Registration Date: <?php echo $row['AdminRegdate']; ?></h6>
                      </div>
                      <div class="card-body">
                      ...
                      <?php } ?>
                      <div class="form-group">
                        <input type="submit" class="btn btn-secondary btn-user btn-block" name="update" id="update" value="Update">
                      </div>
