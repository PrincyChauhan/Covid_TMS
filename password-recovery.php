...
<body style="background-image:url(https://www.wolterskluwer.com/-/media/project/wolterskluwer/oneweb/www/health/division/campaigns/2020/covid19-split-hero.jpg?rev=350708cfe6fa446d84aa9341be717b7c); 
                                ...
                                <div class="col-md-12">
                                    <div class="p-3">
                                        <div class="text-center">
                                            <h1 class="h4 text-blue-900 mb-4">Password Recovery</h1>
                                        </div>
                                        <form class="user">
