...
if (strlen($_SESSION['aid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    echo '<script>alert("Assigned to Worker successfully.")</script>';
...
where  tbltestrecord.id='$testid'");
              ...
              ?>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-secondary">Test Information</h6>
                    </div>
                    <div class="card-body">
                      ...
                      ?>
                        <div class="form-group">
                          <button type="button" class="btn btn-info secondary-sm" data-toggle="modal" data-target="#assignto">Assign To</button>
                        </div>
                        <?php else :
...
where tblreporttracking.OrderNumber='$orderid'");
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-secondary" align="center">Test Tracking History</h6>
                </div>
                <div class="card-body">
                  <?php if ($num > 0) {
                  ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" enctype="multipart/form-data">
              ...
              <p id='reportfile'> Report <span style="color:red; font-size:12px;">(Doc and PDF formate allowed)</span> 
              ...
              <p>
                <input type="submit" class="btn btn-secondary btn-user btn-block" name="takeaction" id="submit">
              </p>
