                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-secondary btn-user btn-block" name="search" value="Search">
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="submit" class="btn btn-secondary btn-user btn-block" name="submit">
                                                    </div>
