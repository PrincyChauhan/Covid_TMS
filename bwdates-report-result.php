                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-secondary">B/W Dates Report Results</h6>
                            </div>
                            <div class="card-body">
    ...
    ");
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="test-details.php?tid=<?php echo $row['testid']; ?>&&oid=<?php echo $row['OrderNumber']; ?>" class="btn btn-secondary btn-sm" target="blank">View Details</a>
