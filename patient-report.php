...
?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary">Search Report Results</h6>
                        </div>
                        <div class="card-body">
...
?>
                                ...
                                <a href="patient-report-details.php?tid=<?php echo $row['testid'];?>&&oid=<?php echo $row['OrderNumber'];?>" class="btn btn-secondary btn-sm" target="blank">View Details</a> 
